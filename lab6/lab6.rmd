...
# Calculate misclassification rates for each income class
...
for (i in 1:4) {
  ...
  # Train the model on the current balanced sample
  model_i <- naiveBayes(sex ~ age + educ + income, data = train_balanced_i)
  
  # Predict on the test set and compute the misclassification rate
